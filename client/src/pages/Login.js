...
export default function Login() {
  ...
  return (
    <>
      {/* sign in */}
      <section className={`${tab === 1 ? "w-full h-[100vh] bg-[#000] flex justify-center  items-center text-[#fff]" : "hidden"}`}>
        <img
          src={judge}
          className="w-full h-[100vh]  absolute blur-xl "
        />
        <div className="absolute w-full h-[100vh] top-0 bottom-0 right-0 left-0 bg-[#0000009d]"></div>
        <img src={imageLogin} className=" w-[638px] h-[570px] absolute top-12 opacity-25 drop-shadow-2xl" />
        ...
        <button
          onClick={() => Signin()}
          className="bg-[#F17119] w-[320px] h-[45px] rounded-lg absolute top-[52%] font-normal"> ورود</button>
        <div className="absolute top-[62%] text-[12px] flex justify-end w-[320px]">
          <p
            onClick={() => setTab(2)}
            className="text-[#F17119] mr-[10px] cursor-pointer">ثبت نام</p>
          <p className="opacity-80  text-[10px]">هنوز ثبت نام نکردی ؟ </p>
        </div>
      </section>

      {/* sign up */}
      <section className={`${tab === 2 ? "w-full h-[100vh] bg-[#000] flex justify-center items-center text-[#fff]" : "hidden"}`}>
        <img
          src={judge}
          className="w-full h-[100vh]  absolute blur-xl "
        />
        <div className="absolute w-full h-[100vh] top-0 bottom-0 right-0 left-0 bg-[#0000009d]"></div>
        <img src={imageLogin} className=" w-[638px] h-[570px] relative top-5 opacity-25 drop-shadow-2xl" />
        <p className="absolute top-[18%] text-[18px]">حساب کاربری خود را ایجاد کنید</p>
        <input
          value={name}
        ...
        <button
          onClick={() => SignUp()}
          className="bg-[#F17119] w-[320px] h-[45px] rounded-lg absolute top-[60%]  font-normal text-[14px]"> ثبت نام</button>
